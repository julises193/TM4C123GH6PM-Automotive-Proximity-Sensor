 ...
 * Bits 0-6 represent segments A-G. Bit 7 is for the colon.
 */
static uint8_t seg7_coding_table[11] = {
        ...
        0b01011011,         // digit 2
        0b01001111,         // digit 3
        0b01100110,         // digit 4 (New: segments B, C, F, G)
        0b01101101,         // digit 5 (New: segments A, C, D, F, G)
        0b01111101,         // digit 6 (New: segments A, C, D, E, F, G)
        0b00000111,         // digit 7 (New: segments A, B, C)
        0b01111111,         // digit 8 (New: all segments on)
        0b01101111,         // digit 9 (New: segments A, B, C, D, F, G)
        0b00000000,         // all off
};
